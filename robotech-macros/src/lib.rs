...
use crate::dao::{
    dao_macro, define_foreign_keys_macro, define_unique_fields_macro, init_dao_macro, DaoArgs,
    DefineForeignKeysArgs, DefineUniqueFieldsArgs,
};
...
#[proc_macro]
pub fn init_dao(_args: TokenStream) -> TokenStream {
    init_dao_macro().into()
}
